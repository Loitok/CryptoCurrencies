...
namespace CryptoCurrencies.Views.Windows
{
    ...
    public partial class CoinView
    {
        ...
        public CoinMarketsViewModel CoinData { get; private set; }
        ...
        private async Task FetchData()
        {
            ...
            if (Dispatcher != null) Dispatcher.Invoke(() => CoinData = data);
        }
        ...
        public CoinView(string coin, string currency)
        {
            ...
            Task.Run(async () =>
            {
                ...
                var descriptionData = await _api.CoinsClient.GetAllCoinDataWithId(_coin, "false", false, false, false, false, false);
